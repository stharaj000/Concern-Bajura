...
export default function OurChildrenPageCMS() {
  ...
  const normalizeChild = (child = {}) => {
    ...
    if (Array.isArray(child.story?.paragraphs)) {
      paragraphs = child.story.paragraphs;
    } else if (Array.isArray(child.story)) {
      paragraphs = child.story;
    }
    ...
    return {
      ...
      details: {
        dateOfBirth:
          child.details?.dateOfBirth ||
          child.dateOfBirth ||
          "",

        birthPlace:
          child.details?.birthPlace ||
          child.birthPlace ||
          "",

        fatherName:
          child.details?.fatherName ||
          child.fatherName ||
          "",

        motherName:
          child.details?.motherName ||
          child.motherName ||
          "",
      },
  ...
  useEffect(() => {
    const fetchOurChildrenPage = async () => {
      try {
        ...
        if (!response.ok) {
          throw new Error(
            "Failed to fetch Our Children page"
          );
        }
        ...
        const normalizedData = {
          ...
          children: {
            ...
            items: Array.isArray(
              ...
              ? data.children.items.map(normalizeChild)
              : [],
          },
          ...
          cta: {
            ...
            button1Text:
              data.cta?.button1Text ||
              data.cta?.buttonText ||
              "",

            button2Text:
              data.cta?.button2Text || "",

            button1Link:
              data.cta?.button1Link || "",

            button2Link:
              data.cta?.button2Link || "",
          },
        };

        setOurChildrenPage(normalizedData);
      } catch (error) {
        console.error(
          "Fetch Our Children page error:",
          error
        );
      } finally {
        setLoading(false);
  ...
  const updateChild = (
    ...
    setOurChildrenPage((prev) => {
      ...
      const child = updatedItems[index];
  ...
  const saveOurChildrenPage =
    async () => {
      setSaving(true);

      try {
        console.log(
          "Saving Our Children page:",
          ourChildrenPage
        );
        ...
        if (!response.ok) {
          throw new Error(
            data.error ||
            "Failed to save Our Children page"
          );
        }
                            ...
                            (
                              ...
                              >
                                ...
                                <textarea
                                  ...
                                  maxLength={
                                    fieldLimits.childEmblaDescription
                                  }
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Together, We Can Create Better Opportunities for Children"
                  className={
                    inputClass
                  }
                />
              ...
              >
                <div>
                  ...
                  <input
                    ...
                    placeholder="Learn About Our Programs"
                    className={
                      inputClass
                    }
                  />
