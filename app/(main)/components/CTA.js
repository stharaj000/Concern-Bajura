...
export default function CTA({ volunteer, donateNow }) {
  return (
    <>
      ...
      <section className="bg-black text-text-white overflow-hidden">
        <div className="w-screen h-[400px] md:h-[600px] relative mx-auto overflow-hidden py-14 flex md:justify-start gap-8 items-center">
          <div className="relative z-10 w-full md:w-1/3 md:left-48 flex flex-col gap-2 overflow-hidden items-center md:items-start mx-6 md:mx-0">
            ...
            <p className="mt-4 text-text-white-secondary text-md md:text-lg text-shadow-md">
              {volunteer.description}
            </p>
            <Link href={volunteer.buttonLink}>
      ...
      <section className="donateSection bg-primary my-36">
        <div className="max-w-6xl h-[400px] md:h-[600px] gap-8 flex justify-center items-center flex-col mx-auto px-4 md:px-6 md:py-14 text-center">
          <h2 className="text-2xl md:text-5xl font-bold text-text tracking-[-0.01em]">
            {donateNow.title}
          </h2>
          <p className="mt-4 text-text text-md md:text-2xl max-w-3xl mx-auto ">
            {donateNow.description}
          </p>
          <Link href="/donate">
            <button className="mt-6 w-fit shadow-lg text-md md:text-2xl bg-secondary text-text-white font-medium px-10 py-5 rounded-lg hover:opacity-90 transition-opacity text-shadow-md hover:cursor-pointer relative overflow-hidden">
